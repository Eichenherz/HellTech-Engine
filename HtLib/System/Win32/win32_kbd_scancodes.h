...
// --- Mouse buttons (after keyboard scan code range 0x000-0x1FF) ---
constexpr u16 HT_MB_LEFT            = 0x200;
constexpr u16 HT_MB_RIGHT           = 0x201;
constexpr u16 HT_MB_MIDDLE          = 0x202;
constexpr u16 HT_MB_4               = 0x203;
constexpr u16 HT_MB_5               = 0x204;
