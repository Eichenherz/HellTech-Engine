...
constexpr vk_access_stage_masks DRAW_INDIRECT_READ			= { VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT, VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT };
constexpr vk_access_stage_masks COLOR_TARGET_OUT_READWRITE	= { HT_COLOR_ATTACHMENT_ACCESS_READ_WRITE, VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT };
